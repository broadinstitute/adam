...
class FindReadsArgs extends Args4jBase with SparkArgs with ParquetArgs {
  @Argument(required = true, metaVar = "INPUT", usage = "The ADAM sequence dictionary to print", index = 0)
  val inputPath: String = null
}

class FindReads(protected val args: FindReadsArgs) extends AdamSparkCommand[FindReadsArgs] {
